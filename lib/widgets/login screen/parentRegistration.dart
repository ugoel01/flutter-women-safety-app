...
class ParentRegistration extends StatefulWidget {
  @override
  State<ParentRegistration> createState() => _UserRegistrationState();
}

class _UserRegistrationState extends State<ParentRegistration> {
                ...
                child: Column(
                  children: [
                    Padding(
                      ...
                      child: Text("PARENT REGISTRATION",style: TextStyle(
                        fontSize: 30,
